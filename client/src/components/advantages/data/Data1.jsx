...
export default [
  {
    ...
    description:
      "По прочности  соединение с помощью \n" +
...

  {
    ...
    description: (
      <span>
        ...
        • Вам не нужно использовать сварочный аппарат; <br />• работу Вы можете
...

  {
    ...
    description:
      "Система соединения позволяет перестроить \n" +
...

  {
    ...
    description:
      "Для выполнения работ Вам не требуется \n" +
